...
3.	$\frac{dn}{dt} = (0.1t + 0.3\cos (t)n(t))(N-n(t))$

При этом объем аудитории $N = 3030$, в начальный момент о товаре знает 24 человек.
